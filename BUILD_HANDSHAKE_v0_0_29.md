# BASIC# Build Handshake v0.0.29

## Identity

- Project: BASIC# Ruby Bootstrap Compiler
- Required base: accepted v0.0.28
- Required commit: `e352457`
- Required tag: `v0.0.28`
- Target: v0.0.29
- Build: First BSharp Virtual Machine and Profile 1 Execution
- Package: `BASIC_Sharp_Ruby_Bootstrap_Compiler_v0_0_29_FIRST_BSHARP_VIRTUAL_MACHINE_AND_PROFILE_1_EXECUTION_CHANGED_FILES_ONLY.zip`
...
After owner installation, acceptance, commit, and tag, propose v0.0.30 Source/BSIR/BSBC Runtime Parity and Hardening.
