# DKScript Build Handshake v0.0.06
...
DKScript_Ruby_Bootstrap_Compiler_v0_0_06_NATURAL_LANGUAGE_ERROR_SAMPLES_AND_AMBIGUITY_TESTS_CHANGED_FILES_ONLY.zip
...
- Updated compiler version constant to `0.0.06`.
...
- Updated README with v0.0.06 diagnostic sample notes.
- Added parser contract v0.0.06.
- Refreshed sample BSharp IR output to version `0.0.06`.
...
```text
README.md
BUILD_HANDSHAKE_v0_0_06.md
compiler/ast_nodes.rb
compiler/parser.rb
docs/parser_contract_v0_0_06.md
...
v0.0.07 should begin tightening the actual world model and/or introduce a first tiny runtime interpreter loop for the BSharp IR debug format, depending on Derek's direction.
