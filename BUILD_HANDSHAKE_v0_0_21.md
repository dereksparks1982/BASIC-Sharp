# BASIC# Build Handshake v0.0.21

## Project and version

- **Project:** BASIC# Ruby Bootstrap Compiler
- **Build:** v0.0.21 Follow-Up Events and Deterministic Event Order
- **Required base:** accepted v0.0.20 BSharp IR Identity Migration
- **Required commit:** `c94faec`
- **Required tag:** `v0.0.20`
- **Target version:** `v0.0.21`
- **Project path:** `/home/dereksparks1982/DKLab/Projects/BASIC#`

## Exact package

`BASIC_Sharp_Ruby_Bootstrap_Compiler_v0_0_21_FOLLOW_UP_EVENTS_AND_DETERMINISTIC_EVENT_ORDER_CORRECTED_CHANGED_FILES_ONLY.zip`
...
The first v0.0.21 package was rejected by its own preflight before any project file changed because its installer expected the wrong accepted-base hash for `README.md`. Repeating that installer produced the same safe rejection.

The corrected candidate was rebuilt by restoring the exact accepted v0.0.20 project state from commit `c94faec`, reapplying the approved v0.0.21 changes, regenerating the BSharp IR samples, rebuilding every base-file hash, and rerunning the full clean-base installer proof.
