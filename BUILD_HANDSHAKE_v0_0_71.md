# BASIC# Build Handshake v0.0.71

Build name: No-Locale CLI Capture Encoding Repair

Base: v0.0.70 (`88a376f8e0e0e98a1b57dc92102bdd28a9f8d1fb`)
...
- Bump active release truth from v0.0.70 to v0.0.71.
...
Next intended build: v0.0.72 Self-Hosting Milestone 2 Proposal.
