# BASIC# Build Handshake v0.1.18

## Project and version

- **Project:** BASIC# Ruby Bootstrap Compiler
- **Build:** v0.1.18 Multiple Selected Things and Deterministic Set Actions
- **Required base:** accepted v0.1.17 Reactive IF Rules and Loop Protection
- **Required commit:** `78fa0c3`
- **Required tag:** `v0.1.17`
- **Target version:** `v0.1.18`
- **Project path:** `/home/dereksparks1982/DKLab/Projects/BASIC#`

## Exact package

`BASIC_Sharp_Ruby_Bootstrap_Compiler_v0_1_18_MULTIPLE_SELECTED_THINGS_AND_DETERMINISTIC_SET_ACTIONS_CHANGED_FILES_ONLY.zip`
...
The installer must reset and clean back to `v0.1.17` if installation or validation fails.
...
After v0.1.18 acceptance, read the updated roadmap and handoff, then present the complete v0.1.19 proposal before implementation.
