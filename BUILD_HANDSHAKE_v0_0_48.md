...
The installer verifies the exact v0.0.47 base before mutation. If validation fails after mutation, it restores every modified v0.0.47 file and removes every added v0.0.48 path.

## Acceptance

v0.0.48 is accepted only after Derek's machine reports installer PASS, then Derek commits the tree and tags `v0.0.48`.
