# BASIC# v0.0.74 Build Handshake

Project: BASIC# Ruby Bootstrap Compiler
Version: v0.0.74 Self-Hosting Milestone 2 Slice 1: Semantic Resolver Independence
Required base: v0.0.73
Required base commit: `f41d70a59f26def52ebb253ea1ad8f20c6e8bc0b`
Required base tag: `v0.0.73`
Package: `BASIC_Sharp_Ruby_Bootstrap_Compiler_v0_0_74_SELF_HOSTING_MILESTONE_2_SEMANTIC_RESOLVER_INDEPENDENCE_CHANGED_FILES_ONLY.zip`
...
- A dedicated v0.0.73 object-interaction fixture proves open, close, lock, and take survive the independent semantic path.
...
Reset exactly to accepted `v0.0.73` at `f41d70a59f26def52ebb253ea1ad8f20c6e8bc0b` before applying a repaired candidate after any failed post-mutation validation.
