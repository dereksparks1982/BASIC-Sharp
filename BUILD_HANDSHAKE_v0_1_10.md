# DKScript Build Handshake v0.1.10
...
Accepted v0.1.09, tagged as `v0.1.09` after local acceptance.
...
`DKScript_Ruby_Bootstrap_Compiler_v0_1_10_RUNTIME_TRIGGER_CONTEXT_CHANGED_FILES_ONLY.zip`
...
```text
docs/changed_files/BASIC_SHARP_CHANGED_FILES_v0_1_10.txt
```
...
After Derek installs, validates, and accepts v0.1.10, the next proposal is v0.1.11 Kind Families. No v0.1.11 work is approved by this handshake.
