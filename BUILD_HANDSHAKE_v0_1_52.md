...
If any installer phase fails after mutation begins, the installer restores the exact v0.1.51 base files and removes candidate v0.1.56 added paths.

## Acceptance

The package is accepted only after the installer reports full native validation PASS on Derek's machine, then Derek commits the exact tree and tags `v0.1.56`.
