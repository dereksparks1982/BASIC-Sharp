# BASIC# Build Handshake v0.1.22

## Project and version

- **Project:** BASIC# Ruby Bootstrap Compiler
- **Build:** v0.1.22 BSharp Save Files and Deterministic World Restore
- **Required base:** accepted v0.1.21 Follow-Up Events and Deterministic Event Order
- **Required commit:** `d67373b`
- **Required tag:** `v0.1.21`
- **Target version:** `v0.1.22`
...
Derek installs and reviews the candidate before commit/tag. After acceptance, read current records and present the v0.1.23 proposal. The roadmap currently points to ASK-style introspection.
