...
Required base: v0.0.26
Required commit: 479db66
Required tag: v0.0.26
Branch: main
Package: BASIC_Sharp_Ruby_Bootstrap_Compiler_v0_0_27_BSHARP_BYTECODE_EMITTER_AND_DETERMINISTIC_DISASSEMBLY_1_CHANGED_FILES_ONLY.zip
```
...
See `docs/changed_files/BASIC_SHARP_CHANGED_FILES_v0_0_27.txt`.
