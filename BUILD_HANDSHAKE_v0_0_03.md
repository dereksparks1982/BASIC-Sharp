# DKScript Build Handshake v0.0.03
...
DKScript v0.0.02 Decision Ledger and Core Dictionary document.

## Target package

DKScript_Ruby_Bootstrap_Compiler_v0_0_03.zip
...
- `docs/parser_contract_v0_0_03.md`
...
Return to v0.0.02 documentation-only state.
