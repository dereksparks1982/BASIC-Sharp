# BASIC# v0.0.43 Rejected Package Audit

## Status

v0.0.43 is rejected and must not be reused as a build number. The accepted base remains v0.0.42 commit `1d79a6221a388ffd6e372d6bfe21d9df1cb38c2c`, tag `v0.0.42`.

## Failure

The delivered v0.0.43 changed-files package stopped before project mutation with:
...
- v0.0.43 is permanently rejected.
- No v0.0.43 commit or tag is accepted.
- No v0.0.43 package should be run again.
- The self-hosting foundation scope is re-carried as v0.0.44.
- v0.0.44 packaging must prove the installer has zero literal NUL bytes before delivery.
