...
v0.1.61 re-carries Self-Hosting Milestone 1 directly from accepted v0.1.59, adds the missing README contract reference, advances every active version surface to v0.1.61, and is not deliverable until the exact sealed v0.1.61 installer has passed against a disposable clean copy of accepted v0.1.59.
