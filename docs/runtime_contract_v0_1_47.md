# BASIC# Runtime Contract v0.1.47

v0.1.47 changes no runtime semantics.

Stable Meaning Profiles 1 through 7, BSharp Bytecode Profiles 1 through 7, BSharp Save formats, BSharp ASK behavior, the BSharp VM preferred runtime, and the v0.1.46 input-device meaning layer remain the accepted language/runtime surface.
