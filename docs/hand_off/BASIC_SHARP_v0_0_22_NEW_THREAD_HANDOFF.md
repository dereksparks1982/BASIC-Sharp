# BASIC# v0.0.22 New Thread Handoff

## Required base

- Project: BASIC# Ruby Bootstrap Compiler
- Base version: v0.0.21
- Base commit: `d67373b`
- Base tag: `v0.0.21`
- Target: v0.0.22 BSharp Save Files and Deterministic World Restore
...
Read every updated record and present a full v0.0.23 proposal. The roadmap currently points to ASK-style introspection. Do not build it without Derek's explicit approval.
