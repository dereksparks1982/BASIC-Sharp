# BASIC# v0.0.17 New Thread Handoff
...
- v0.0.13, v0.0.15, and v0.0.16 fixture compatibility.
...
Derek installs and reviews the candidate. If accepted, commit and tag v0.0.17. Then read the current roadmap and present the complete next-build proposal before implementation.
