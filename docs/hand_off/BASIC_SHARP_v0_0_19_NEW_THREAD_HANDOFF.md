# BASIC# v0.0.19 New Thread Handoff

## Candidate

- **Build:** v0.0.19 Whole-Number Values and Damage Amounts
- **Required base:** accepted v0.0.18
- **Base commit:** `05eaf68`
- **Base tag:** `v0.0.18`
- **Package:** `BASIC_Sharp_Ruby_Bootstrap_Compiler_v0_0_19_WHOLE_NUMBER_VALUES_AND_DAMAGE_AMOUNTS_CHANGED_FILES_ONLY.zip`
...
Commit `05eaf68`, tag `v0.0.18`.

## Continuation

After Derek installs and accepts, commit and tag v0.0.19. Then read all current records and present the v0.0.20 proposal before implementation.
