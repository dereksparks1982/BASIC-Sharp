# DKScript Parser Contract v0.0.10
...
## v0.0.10 parser status

No new syntax was added. The parser and resolver structures already present in v0.0.09 are now used by the runtime.
