# BASIC# BSharp Bytecode Architecture v0.0.26
...
v0.0.26 defines the architecture and validates the contract. It deliberately does not emit or execute bytecode.
