# BASIC# v0.0.28 BSharp Bytecode Loader and Complete Structural Validation 1

## Purpose

v0.0.28 adds the first arbitrary `.bsbc` reader. It validates the complete BSharp Bytecode Profile 1 artifact before exposing a trusted program model.
...
The six v0.0.27 sample `.bsbc` files and their hashes remain unchanged. Loader-generated disassembly must exactly equal each committed `.bsbc.txt` companion.
