# BASIC# v0.1.30 VM Parity, BSharp Save, BSharp ASK, and Hardening

## Purpose

v0.1.30 completes the first hardened Profile 1 bytecode runtime milestone. The BSharp VM continues to interpret the validated BSBC model directly, while gaining the same current-world services already available through the reference runtime.
...
No BSharp Bytecode binary layout, BSharp Save schema, BSharp ASK schema, Meaning Profile 1 behavior, or creator-facing syntax changes in v0.1.30.
