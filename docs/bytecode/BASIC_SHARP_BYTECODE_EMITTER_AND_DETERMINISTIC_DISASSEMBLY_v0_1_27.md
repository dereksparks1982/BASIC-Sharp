# BASIC# v0.1.27 BSharp Bytecode Emitter and Deterministic Disassembly 1
...
v0.1.27 turns resolved BSharp IR meaning into the first real BSharp Bytecode artifacts governed by `bsharp.bytecode.v1`.
