# BASIC# Runtime Contract v0.0.18
...
Supported set actions in v0.0.18:
...
Valid saved BSharp IR fixtures from v0.0.13, v0.0.15, v0.0.16, and v0.0.17 remain executable.
