# BASIC# Runtime Contract v0.0.14

## Scope

v0.0.14 changes technical identity and project documentation without changing accepted runtime behavior.
...
The runtime continues to accept `bsir.debug.json`. A saved v0.0.13 BSharp IR fixture is included and tested. The version field identifies the producing compiler but does not prevent v0.0.14 from executing that accepted document.
