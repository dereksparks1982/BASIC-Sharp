# Historical BASIC Research and BASIC# Roadmap v0.1.11
...
No BASIC# ASK syntax is approved in v0.1.11.
...
These are proposed design questions only. v0.1.11 does not implement them.
...
None of these has been implemented by v0.1.11.
