# BASIC# Parser Contract v0.1.20

## Scope

v0.1.20 changes identity and saved representation naming only. It does not change BASIC# grammar, Heads, official words, references, number syntax, selection meaning, or IF meaning.
