# BASIC# ASK Contract v0.1.32

BSharp ASK remains read-only and deterministic. v0.1.32 adds typed text visibility without changing accepted questions or mutation guarantees.
