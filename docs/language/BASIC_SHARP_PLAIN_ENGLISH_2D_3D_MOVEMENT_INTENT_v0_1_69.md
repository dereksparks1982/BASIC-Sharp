# BASIC# Plain-English 2D and 3D Movement Intent v0.1.69

BASIC# v0.1.69 separates 2D screen movement from 3D facing-direction movement.
...
The 2D and 3D movement intent contract remains preserved while v0.1.69 hardens release forensics. No new movement syntax is added in v0.1.69.
