# BASIC# Plain-English Input Mapping v0.0.68

BASIC# v0.0.68 lets a creator declare player actions by meaning instead of writing a separate script for every device.
