# BASIC# Plain-English Movement and Input v0.0.46

v0.0.46 keeps creator source focused on movement meaning instead of hardware details.
...
The declaration above continues to mean left movement, right movement, and grounded jump. v0.0.46 additionally accepts equivalent device input:
