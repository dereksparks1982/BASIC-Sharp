# BASIC# Language Foundation v0.0.11
...
The current repository and Ruby bootstrap still use the historical `DKScript` technical name. That technical rename is not part of v0.0.11.
...
v0.0.11 records the identity and doctrine. It does not perform the technical rename and it does not add syntax.
