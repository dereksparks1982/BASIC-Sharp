# BASIC# Plain-English Input Mapping v0.0.69

BASIC# v0.0.69 preserves the accepted input mapping that lets a creator declare player actions by meaning instead of writing a separate script for every device.
...
## v0.0.69 carry-forward note

This document remains the current input mapping reference while v0.0.69 hardens release forensics. No new input syntax is added in v0.0.69.
