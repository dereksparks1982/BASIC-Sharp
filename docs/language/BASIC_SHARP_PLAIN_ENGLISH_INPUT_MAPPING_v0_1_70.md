# BASIC# Plain-English Input Mapping v0.1.70

BASIC# v0.1.70 preserves the accepted input mapping that lets a creator declare player actions by meaning instead of writing a separate script for every device.
...
## v0.1.70 carry-forward note

This document remains the current input mapping reference while v0.1.70 hardens release forensics. No new input syntax is added in v0.1.70.
