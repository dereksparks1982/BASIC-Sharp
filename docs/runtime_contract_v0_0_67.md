# BASIC# Runtime Contract v0.0.67

v0.0.67 adds `move_3d` as a host command emitted by `BasicSharp::GameInput` when a resolved `CONTROLS for PLAYER` declaration uses 3D movement intent.
