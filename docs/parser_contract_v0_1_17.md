# BASIC# Parser Contract v0.1.17

## Status

The v0.1.17 build changes runtime IF behavior but does not expand parser grammar.
...
- No AND, OR, OTHERWISE, numeric comparison, Kind selector, or `that Kind` condition enters v0.1.17.
