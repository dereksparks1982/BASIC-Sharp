# BASIC# Compatibility Policy v0.1.24
...
Once v0.1.24 is accepted, Profile 1 meaning is immutable.
...
Any future schema migration requires an explicit approved scope. v0.1.24 performs no schema migration.
