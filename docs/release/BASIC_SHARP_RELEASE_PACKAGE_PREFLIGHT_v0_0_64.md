# BASIC# Release Package Preflight v0.0.64

v0.0.64 adds a release preflight gate so a changed-files package cannot be entered into acceptance validation merely because one local symptom was repaired.
