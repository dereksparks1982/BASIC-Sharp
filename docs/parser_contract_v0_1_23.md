# BASIC# Parser Contract v0.1.23

v0.1.23 adds no creator-language syntax, Head, Connector, or official word.

The accepted v0.1.22 parser behavior remains unchanged:
