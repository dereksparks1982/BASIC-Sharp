# DKScript Parser Contract v0.0.11
...
The current parser, Ruby module, command, repository, and package names remain under the historical DKScript bootstrap identity in v0.0.11. A technical rename is excluded.
...
The v0.0.10 parser and resolver information used for `a guard` and `that guard` remains unchanged.

## v0.0.11 parser status
