# BASIC# Changelog v0.0.35

- Re-carried the complete Profile 3 work after v0.0.34 failed owner-side runtime-transition validation and rolled back to v0.0.32.
...
- Advanced active compiler, runtime, generated artifacts, tests, documentation, manifest, and package identity to v0.0.35.
