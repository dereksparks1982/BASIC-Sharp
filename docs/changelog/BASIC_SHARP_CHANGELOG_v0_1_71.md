# BASIC# Changelog v0.1.71

v0.1.71 fixes the no-locale CLI capture encoding defect found after v0.1.70.
...
- Updated active version truth to `0.1.71`.
- Regenerated version-bearing golden records where the version bump legitimately changes BSIR, BSBC, save, or runtime digests.
- Updated release truth records so v0.1.72 can return to the larger self-hosting/game-making path.
