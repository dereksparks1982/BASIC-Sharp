...
The self-hosting execution corpus expands to 18 fixtures and 56 events, including a dedicated object-interaction case that carries the accepted v0.0.73 open, close, lock, and take actions through independent semantic resolution, BSBC emission, loading, BSharp VM execution, and Ruby-referee comparison.
