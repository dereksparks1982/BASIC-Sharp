...
- Added `docs/self_hosting/BASIC_SHARP_SMALL_COMPILER_SUBSET_IR_EMITTER_v0_0_50.md`.
- Advanced live BASIC# version truth to `0.0.50`.
- Regenerated current version-bearing runtime fixture hashes for v0.0.50.
