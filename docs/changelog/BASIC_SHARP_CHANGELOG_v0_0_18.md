# BASIC# Changelog v0.0.18

## Added

- Executable `every Kind` action targets.
- Direct and inherited Kind set selection in definition order.
...
- v0.0.17 saved-BSharp IR fixture.

## Changed

- Runtime action execution now supports one ordered target snapshot per action line.
- Active version surfaces now report v0.0.18.

## Preserved

- Named and definite singular references.
