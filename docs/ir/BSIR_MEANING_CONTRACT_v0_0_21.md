# BSharp IR Meaning Contract v0.0.21
...
`dkir.debug.json` remains retired and unsupported. The approved v0.0.20 transition message remains the recovery guidance.
