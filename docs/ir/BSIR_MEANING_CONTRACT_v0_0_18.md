# BSharp IR Meaning Contract v0.0.18
...
A `kind_set` is valid only as the target of an official word inside a WHEN or IF action list in v0.0.18.
...
The runtime accepts valid accepted fixtures from v0.0.13, v0.0.15, v0.0.16, and v0.0.17.
