# BSharp IR Meaning Contract v0.1.20
...
The v0.1.20 identity migration does not redesign the document structure. Kinds, Things, facts, events, IF rules, references, values, amounts, and diagnostics retain their accepted v0.1.19 meaning.
