# BSharp IR Meaning Contract v0.0.16
...
The runtime accepts valid v0.0.13 and v0.0.15 BSharp IR fixtures. Stricter rejection applies only to malformed documents that were never valid language truth.
