# BSharp IR Meaning Contract v0.0.22
...
- Current creator-source compiler version: `0.0.22`

## Preserved meaning

v0.0.22 changes no BSharp IR language meaning. Kinds, objects, START facts, WHEN rules, IF rules, references, values, amounts, and caused-event templates retain the v0.0.21 structure and behavior.

Current generated `.bsir.json` samples carry version `0.0.22`.
...
`dkir.debug.json` remains retired and unsupported with the exact approved v0.0.20 diagnostic.
