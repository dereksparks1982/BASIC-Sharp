# BSharp IR Meaning Contract v0.0.17
...
v0.0.17 does not add a new IF field or redesign the schema.
...
The runtime accepts valid accepted fixtures from v0.0.13, v0.0.15, and v0.0.16.
