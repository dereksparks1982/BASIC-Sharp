# BASIC# v0.0.79 Small Compiler Subset Independent Compiler Driver

v0.0.79 advances Self-Hosting Milestone 2 Slice 6 by placing a bounded compiler-driver boundary in front of the accepted v0.0.78 integrated independent pipeline.
