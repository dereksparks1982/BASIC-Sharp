# BASIC# v0.0.78 Small Compiler Subset Integrated Independent Compiler Pipeline

BASIC# v0.0.78 adds Self-Hosting Milestone 2 Slice 5 by connecting the bounded Subset 0 compiler stages behind one `SmallCompilerSubsetPipeline` source-to-world path.
