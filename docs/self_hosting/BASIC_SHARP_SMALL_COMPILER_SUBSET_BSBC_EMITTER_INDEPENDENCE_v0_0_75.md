# BASIC# v0.0.75 Small Compiler Subset BSBC Emitter Independence

BASIC# v0.0.75 advances Self-Hosting Milestone 2 with Slice 2: BSBC Emitter Independence.
...
The dedicated v0.0.75 fixture combines open, close, lock, take, whole-number increase, IF, and OTHERWISE so the new encoder is proved against a mixed real-language program rather than a toy artifact.
