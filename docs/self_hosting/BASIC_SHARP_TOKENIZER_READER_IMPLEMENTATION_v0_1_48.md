# BASIC# Tokenizer and Reader Implementation v0.1.48
...
v0.1.48 begins the first BASIC# tokenizer/reader implementation on the self-hosting runway.
...
v0.1.48 implements these token kinds only:
...
`compiler/tokenizer_reader.rb` is not the production parser authority in v0.1.48.
...
5. Derek commits the exact accepted tree and tags `v0.1.48`.
