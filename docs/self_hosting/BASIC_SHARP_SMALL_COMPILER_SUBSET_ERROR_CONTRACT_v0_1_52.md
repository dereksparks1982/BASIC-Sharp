# BASIC# Small Compiler Subset Error Contract v0.1.56
...
v0.1.56 adds the plain-English error contract for the small compiler subset. The contract gives invalid subset examples stable error IDs, source line numbers, severity, creator-facing explanations, and the underlying Ruby-referee diagnostic that produced each result.
...
After v0.1.56 is accepted, the next likely self-hosting build is controlled subset expansion or the bytecode-emission lane, still under Ruby referee control.
