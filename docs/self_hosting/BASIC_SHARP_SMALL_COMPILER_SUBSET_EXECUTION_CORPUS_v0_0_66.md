# BASIC# Small Compiler Subset Execution Corpus v0.0.66

v0.0.66 expands the BSBC execution parity lane from a smaller proof set into a sealed execution corpus.
