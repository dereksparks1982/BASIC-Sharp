...
The parser lane is the required input for the next self-hosting bridge record: `spec/self_hosting/BASIC_SHARP_SMALL_COMPILER_SUBSET_IR_EMITTER_v1.json`. The v0.1.51 emitter may consume parser records, but the parser remains non-production and Ruby remains the referee.
