# BASIC# Small Compiler Subset Execution Corpus v0.1.67

v0.1.67 carries forward the v0.1.66 BSBC execution corpus while adding plain-English movement intent coverage outside the self-hosting fixture corpus.
