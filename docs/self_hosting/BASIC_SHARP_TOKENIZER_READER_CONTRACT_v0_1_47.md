# BASIC# Tokenizer and Reader Contract v0.1.47
...
v0.1.47 freezes the first self-hosting tokenizer/reader contract without replacing the Ruby bootstrap compiler.
...
This is the next plank after the v0.1.44 self-hosting foundation and the v0.1.46 movement/input lane.
