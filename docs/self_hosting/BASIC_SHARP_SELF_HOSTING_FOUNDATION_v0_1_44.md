# BASIC# Self-Hosting Foundation v0.1.44

## Purpose

v0.1.44 re-carries the self-hosting lane after the rejected v0.1.43 package and starts it without pretending BASIC# can replace Ruby yet. It defines **BSharp Compiler Subset 0**, the first compiler-writing contract for future BASIC# compiler work.
...
1. v0.1.44 records v0.1.43 as rejected, then freezes this contract and validation gate.
