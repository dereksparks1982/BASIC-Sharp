# Copilot BASIC# Review Decision Record v0.1.12
...
That idea is accepted as v0.1.12, using the next unused version number.
...
- Copilot's proposed version number was stale after v0.1.11 was used.
