# BASIC# Runtime Contract v0.0.44

v0.0.44 changes no creator-facing runtime meaning. Stable Meaning Profiles 1 through 7 and BSharp Bytecode Profiles 1 through 7 remain the accepted language/runtime surface.
...
Every version-bearing runtime fixture is regenerated for `BasicSharp::VERSION == 0.0.44` and remains protected by the same stress gates introduced in v0.0.42.
