# DKScript Parser Contract v0.0.04
...
v0.0.04 keeps the Ruby Stage 0 compiler front end and adds the first semantic resolver plus a human-readable BSharp IR debug dump.
