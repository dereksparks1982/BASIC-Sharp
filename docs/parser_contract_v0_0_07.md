# DKScript Parser Contract v0.0.07
...
Accepted DKScript v0.0.06 in `/home/dereksparks1982/DKLab/Projects/DKScript`.

## Purpose

v0.0.07 does not add runtime execution. It cleans the compiler's voice.

v0.0.06 proved that bad DKScript samples produce errors. v0.0.07 makes those errors easier for non-programmers to trust by reporting each distinct problem once and avoiding follow-up errors caused only by an earlier typo.
