# BASIC# Trial by Fire Complete Re-Carry v0.0.42
...
- Re-carried recorded campaign seed: `11862336` (`0xB50140`), preserved from the failed v0.0.40 candidate so the same adversarial campaign remains directly comparable.
