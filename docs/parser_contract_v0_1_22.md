# BASIC# Parser Contract v0.1.22

v0.1.22 adds no creator-language syntax, Head, Connector, or official word.

The accepted v0.1.21 parser behavior remains unchanged:
