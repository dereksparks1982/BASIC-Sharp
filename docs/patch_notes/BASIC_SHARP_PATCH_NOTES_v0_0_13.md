...
The final archive is a corrected incremental changed-files-only patch over accepted v0.0.12. Earlier v0.0.13 archives are rejected and must not be committed or tagged.
