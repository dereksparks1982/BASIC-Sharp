# BASIC# Patch Notes v0.1.49

v0.1.49 starts the small compiler subset parser lane under Ruby referee control.
...
- v0.1.49 build handshake, validation, changelog, session log, runtime contract, and changed-files record

## Changed

- Live version surfaces now report `0.1.49`.
