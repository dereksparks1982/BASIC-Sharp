# BASIC# Patch Notes v0.0.50

v0.0.50 teaches the small compiler subset to emit BSharp IR while Ruby remains the referee.
...
- v0.0.50 build handshake, validation, changelog, session log, runtime contract, and changed-files record
