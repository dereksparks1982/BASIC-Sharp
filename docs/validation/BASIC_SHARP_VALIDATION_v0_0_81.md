...
- accepted v0.0.80 bootstrap artifact produces v0.0.81 generation #1;
- generated v0.0.81 artifact produces generation #2;
...
Accepted v0.0.80 floor: 660 runs, 9,998 assertions, 0 failures, 0 errors, 0 skips across 83 test files, with 71 required tools, 325 sealed artifacts, and 14 protected artifacts.

Build-side v0.0.81 complete normal and no-locale suites: 670 runs, 10,052 assertions, 0 failures, 0 errors, 0 skips across 84 test files. Native installer validation remains authoritative for release acceptance.
