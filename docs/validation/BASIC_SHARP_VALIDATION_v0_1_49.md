...
BASIC# v0.1.49 TRIAL BY FIRE: PASS
```
...
Derek's installer must run from exact clean v0.1.48 commit `c67c74251aaa58e4f2fcded1144ea5187eebfb25` and tag `v0.1.48`.
