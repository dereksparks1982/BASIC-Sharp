...
The installer must verify clean `main` at commit `ef43056`, tag `v0.1.36`, every base and payload hash, exact scope, the complete native suite, every focused/stress lane, and automatic exact rollback to v0.1.36 after any post-mutation failure.
