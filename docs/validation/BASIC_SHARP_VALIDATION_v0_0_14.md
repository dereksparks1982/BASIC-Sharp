...
```text
BASIC# Runtime Stress Test v0.0.14
Things: 504
...
- Compiler banner: `BASIC# Ruby Bootstrap Compiler v0.0.14`.
- Runtime banner: `BASIC# Runtime v0.0.14`.
- Company Bible integration contains at least 74 files.

## Compatibility validation

A saved v0.0.13 `bsir.debug.json` fixture executed through the v0.0.14 runtime and produced the expected direct-Kind Trigger match, selected-Thing context, damage, and state change.
