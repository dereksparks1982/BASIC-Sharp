...
```text
DKScript Ruby Bootstrap Compiler v0.0.10
statements: 7
kinds: 1
definitions: 5
facts: 4
...
The changed-files-only payload was applied to a clean v0.0.09 reconstruction. The full v0.0.10 suite passed with the same result.
