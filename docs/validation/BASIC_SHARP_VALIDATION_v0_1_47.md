# BASIC# Validation v0.1.47

## Build

- Version: v0.1.47
- Title: Tokenizer/Reader Contract and Universal Standard Doctrine
- Required base: v0.1.46 commit `b4d8ea2c5274e63cab3de6e6fcf003e2aef25a35`
...
BASIC# v0.1.47 TRIAL BY FIRE: PASS
```
...
Derek's installer must run from exact clean v0.1.46 commit `b4d8ea2c5274e63cab3de6e6fcf003e2aef25a35` and tag `v0.1.46`.
