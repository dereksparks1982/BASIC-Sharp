...
v0.1.46 also records v0.1.45 as rejected. The native failure was a timing/isolation error in the Xbox jump test, not a rejected controller-mapping design.
...
## v0.1.46 version-bearing fixture hashes
...
The first v0.1.46 changed-files-only package was rejected because version-bearing fixture hashes were stale. This repaired package records the native Ruby v0.1.46 fixture hashes and is the only v0.1.46 package that should be installed from the rescued v0.1.44 base.

## Required native acceptance

The v0.1.46 installer must run from exact accepted v0.1.44 commit `b630b031666a527d8549e6715e59065071a3efd0`, tag `v0.1.44`, clean `main`.
...
Any post-mutation failure restores exact v0.1.44. Derek acceptance requires native PASS, commit, tag `v0.1.46`, clean tree, and accepted full-project snapshot.
