...
```text
DKScript Ruby Bootstrap Compiler v0.1.12
statements: 7
kinds: 1
definitions: 5
facts: 4
...
## Clean v0.1.11 overlay proof

The changed-files payload was applied to a clean v0.1.11 copy.
