...
- Version: v0.0.63
- Base: v0.0.51 / `2962fa19b3e452e529ac7166ad3e751bf621cde4`
...
The first v0.0.63 candidate failed at `tools/text_value_stress.rb` with `Save fixture hash: FAIL` and restored exact v0.0.51. The repaired candidate updates the v0.0.63 text-value Save fixture hash and must pass `tools/text_value_stress.rb` before acceptance.
