# BASIC# Validation v0.1.48

## Build

- Version: v0.1.48
- Title: Tokenizer/Reader Implementation Under Ruby Referee
- Required base: v0.1.47 commit `3e0832f052b91507cfd0615be44e65960f38740f`
...
BASIC# v0.1.48 TRIAL BY FIRE: PASS
```
...
Derek's installer must run from exact clean v0.1.47 commit `3e0832f052b91507cfd0615be44e65960f38740f` and tag `v0.1.47`.
