...
- v0.0.44 version-bearing fixture audit.
- Runtime-generated fixture hashes reproduced with `BasicSharp::VERSION` forced to `0.0.44`.
...
## v0.0.44 version-bearing fixture hashes
...
The v0.0.44 installer must run from exact accepted v0.0.42 commit `1d79a6221a388ffd6e372d6bfe21d9df1cb38c2c`, tag `v0.0.42`, clean `main`.
...
Any post-mutation failure restores exact v0.0.42. Derek acceptance requires native PASS, commit, tag `v0.0.44`, clean tree, and accepted full-project snapshot.
