...
- Direct `.bsbc` execution independently reported `BSharp Virtual Machine v0.1.35`; explicit reference mode independently reported `BASIC# Runtime v0.1.35`.
