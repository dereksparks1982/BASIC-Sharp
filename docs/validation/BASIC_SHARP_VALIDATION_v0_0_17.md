...
64 overlapping ancestor Triggers PASS
500 descendant Things PASS
exact priority PASS
nearest priority PASS
source-order tie PASS
...
```text
v0.0.13 saved BSharp IR PASS
v0.0.15 saved BSharp IR PASS
v0.0.16 saved BSharp IR PASS
```
