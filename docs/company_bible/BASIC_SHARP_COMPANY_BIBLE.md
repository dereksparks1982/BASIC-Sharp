...
### v0.1.56 Small Compiler Subset Error Contract
...
### v0.1.56 Small Compiler Subset Scene/Block Expansion
...
## v0.1.56 Symbol Table Contract and ByteTide Decision

The v0.1.56 lane adds `compiler/small_compiler_subset_symbol_table_contract.rb`, `spec/self_hosting/BASIC_SHARP_SMALL_COMPILER_SUBSET_SYMBOL_TABLE_CONTRACT_v1.json`, and `docs/self_hosting/BASIC_SHARP_SMALL_COMPILER_SUBSET_SYMBOL_TABLE_CONTRACT_v0_1_54.md`.
