# DKScript Build Handshake v0.0.05
...
v0.0.05 Semantic Diagnostics + IR File Output

## Required base

Accepted DKScript v0.0.04 Semantic Resolver + Human-Readable IR Dump in `/home/dereksparks1982/DKLab/Projects/DKScript`.

## Target package

DKScript_Ruby_Bootstrap_Compiler_v0_0_05_SEMANTIC_DIAGNOSTICS_AND_IR_FILE_OUTPUT_CHANGED_FILES_ONLY.zip

## Completed changes

- Updated compiler version to `0.0.05`.
...
- Updated resolver and IR tests for v0.0.05.
- Added v0.0.05 parser contract documentation.
...
Run from project root after applying over v0.0.04:
