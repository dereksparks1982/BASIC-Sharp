...
- Required base: v0.0.51
- Required commit: `2962fa19b3e452e529ac7166ad3e751bf621cde4`
- Required tag: `v0.0.51`
- Required branch: `main`
- Package: `BASIC_Sharp_Ruby_Bootstrap_Compiler_v0_0_52_SMALL_COMPILER_SUBSET_ERROR_CONTRACT_CHANGED_FILES_ONLY.zip`
...
If any installer phase fails after mutation begins, the installer restores the exact v0.0.51 base files and removes candidate v0.0.63 added paths.

## Acceptance

The package is accepted only after the installer reports full native validation PASS on Derek's machine, then Derek commits the exact tree and tags `v0.0.63`.
