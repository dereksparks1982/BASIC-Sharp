# DKScript Build Handshake v0.1.11
...
Accepted v0.1.09, tag `v0.1.09`.

The package is cumulative and includes the unaccepted v0.1.10 Runtime Trigger Context candidate.
...
`DKScript_Ruby_Bootstrap_Compiler_v0_1_11_BASIC_SHARP_LANGUAGE_FOUNDATION_AND_HISTORICAL_BASIC_RESEARCH_CHANGED_FILES_ONLY.zip`
...
```text
docs/changed_files/BASIC_SHARP_CHANGED_FILES_v0_1_11.txt
```
...
```bash
git checkout v0.1.09
```

## Current continuation point

After Derek installs, validates, and accepts v0.1.11, the next proposal is v0.1.12 Kind Families. No v0.1.12 work is approved by this handshake.
