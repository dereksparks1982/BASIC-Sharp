...
class TestIdentityMigration < Minitest::Test
  ...
  def test_basic_sharp_is_the_only_active_ruby_namespace
    ...
    assert_equal '0.1.37', BasicSharp::VERSION
  end
  ...
  def test_compiler_and_runtime_banners_use_basic_sharp_identity
    ...
    assert_includes stdout, 'BASIC# Ruby Bootstrap Compiler v0.1.37'
    ...
    assert_includes run_stdout, 'BSharp Virtual Machine v0.1.37'
