...
class TestFirstRoom < Minitest::Test
  ...
  def test_actions_are_detected
    ...
    assert_equal %w[carry damage change damage change damage change unlock damage], actions.map(&:verb)
  end
