...
class TestReleasePackagePreflight < Minitest::Test
  ...
  def test_manifest_requirements_are_current_versioned
    ...
    assert_equal 'BUILD_BASIC_SHARP_v0_0_84_SELF_HOSTING_NATIVE_ACTION_ROUTING.sh', spec.fetch('required_installer')
  ...
  def test_forbids_unproven_package_handoff
    ...
    assert_includes forbidden, 'removing the DKLab compatibility bridge in v0.0.84'
