...
v0.1.04 Semantic Resolver + Human-Readable IR Dump

## Required base

Accepted DKScript v0.1.03 Ruby Bootstrap Compiler Prototype.

## Target package

DKScript_Ruby_Bootstrap_Compiler_v0_1_04_SEMANTIC_RESOLVER_AND_IR_OUTPUT_CHANGED_FILES_ONLY.zip
...
- Added v0.1.04 parser contract documentation.
- Updated README.
