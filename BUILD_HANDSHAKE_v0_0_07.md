# DKScript Build Handshake v0.0.07
...
DKScript_Ruby_Bootstrap_Compiler_v0_0_07_DIAGNOSTIC_DEDUPING_AND_CASCADE_CLEANUP_CHANGED_FILES_ONLY.zip
...
- Updated compiler version constant to `0.0.07`.
...
- Refreshed sample BSharp IR output to version `0.0.07`.
...
Run from project root after applying over v0.0.06:
