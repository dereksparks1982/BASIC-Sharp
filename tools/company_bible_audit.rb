...
RETIRED_SOURCES = [
  "docs/company_bible/BASIC_SHARP_COMPANY_BIBLE_CARRYOVER_v0_0_14.md",
  "docs/company_bible/COMPANY_BIBLE_ADDENDUM_v0.0.87_No_Loose_Files.md",
  "docs/company_bible/COMPANY_BIBLE_ADDENDUM_v0.0.88_NES_Overworld_Cell_Build_Safety.md",
  ...
  "docs/company_bible/DK_Godot_v0_0_13_Documentation_Record_Note.md",
  "docs/company_bible/DK_Godot_v0_0_16_Immediate_Patch_Inclusion_Rule.md",
  "docs/company_bible/DK_Godot_v0_0_17_Documentation_Discipline_Addendum.md",
  "docs/company_bible/DK_Godot_v0_0_18_Immediate_Request_Completion_Reinforcement.md",
  "docs/company_bible/DK_Godot_v0_0_18_No_Image_Unless_Explicit_Rule.md",
  "docs/company_bible/DK_Godot_v0_0_19_FailedPatchRetry_Documentation_Rule.md",
  "docs/company_bible/DK_Godot_v0_0_20_Failed_Visual_Patch_Retry_Rule.md",
  "docs/company_bible/DK_Godot_v0_0_82_RESTORE_OLD_CELLS_KEEP_NEWMAP_VISIBLE_NO_MAP_REPLACEMENT_RULE.md",
  "docs/company_bible/DK_Godot_v0_0_89_MAIN_INSURANCE_POLICY_ADDENDUM.md",
  "docs/company_bible/DK_Godot_v0_0_90_VERSIONING_AND_MAIN_SAFETY_ADDENDUM.md",
  "docs/company_bible/DK_Godot_v0_0_91_DOOR_NAMING_AND_MAIN_UID_SAFETY_ADDENDUM.md",
  "docs/company_bible/DK_Godot_v0_0_92_PROJECT_IDENTITY_RULE_ADDENDUM.md",
...
MANDATORY_TEXT = [
  ...
  'The final decision authority governs BASIC#',
  'Acknowledge the current instruction before beginning lengthy inspection or tool work.',
  'Implementation begins only after explicit approval',
  'When a **stop** instruction is given',
  ...
  'Only generate or edit an image when a clear direct command explicitly requests image work',
  'Commercialization is intentionally shelved',
  'reasonably priced monthly option',
  'Adobe-style loss of local tool access',
  'v0.0.25 consolidation ledger',
  ...
  'Elderedd Laboratory',
  'BCS',
  'The BASIC# GitHub repository is public.',
