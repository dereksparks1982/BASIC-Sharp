...
parser = BasicSharp::Parser.new(File.read(File.join(root, 'samples/number_changes.bsharp'), encoding: 'UTF-8'))
...
fixture = JSON.parse(File.read(File.join(root, 'spec/bytecode_v5/BASIC_SHARP_BYTECODE_PROFILE_v5_FIXTURES_v1.json'), encoding: 'UTF-8'))
