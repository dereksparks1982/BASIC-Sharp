...
profile_6 = BasicSharp::BytecodeContract.load_profile(File.join(root, 'spec/bytecode_v6/BASIC_SHARP_BYTECODE_PROFILE_v6.json'))
BasicSharp::BytecodeContract.validate_profile!(profile_6, root: root)
profile_7 = BasicSharp::BytecodeContract.load_profile(File.join(root, 'spec/bytecode_v7/BASIC_SHARP_BYTECODE_PROFILE_v7.json'))
BasicSharp::BytecodeContract.validate_profile!(profile_7, root: root)
...
puts 'Profile 6 compound IF condition coverage: PASS'
puts 'Profile 7 IF and OTHERWISE branch coverage: PASS'
