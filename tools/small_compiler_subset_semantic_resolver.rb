...
assert_contract!(emitter_source.include?('SmallCompilerSubsetSemanticResolver.new(program, dictionary: dictionary, native_symbol_resolver: native_symbol_resolver)'), 'subset IR emitter does not use the independent resolver')
