...
fixture = JSON.parse(File.read(File.join(root, 'spec/runtime_v6/BASIC_SHARP_COMPOUND_IF_RUNTIME_FIXTURES_v1.json')))
...
assert_stress(sample_actual == JSON.parse(File.read(expected_path)), 'compound IF runtime fixture behavior changed')
