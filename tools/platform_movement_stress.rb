...
fixture = JSON.parse(File.read(File.join(root, 'spec/runtime_v4/BASIC_SHARP_PLATFORM_MOVEMENT_RUNTIME_FIXTURES_v1.json'), encoding: 'UTF-8'))
...
fixture_events = JSON.parse(File.read(File.join(root, fixture.fetch('input')), encoding: 'UTF-8'))
