...
assert_contract!(spec.fetch('removal_status') == 'forbidden_in_v0.1.70', 'bridge removal status mismatch')
...
assert_contract!(spec.fetch('forbidden').include?('removing the DKLab compatibility bridge in v0.1.70'), 'bridge removal must be forbidden')
