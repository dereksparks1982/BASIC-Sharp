...
- Package: `BASIC_Sharp_Ruby_Bootstrap_Compiler_v0_0_52_IR_GOLDEN_PARITY_HARNESS_CHANGED_FILES_ONLY.zip`
...
If any installer phase fails after mutation begins, the installer restores the exact v0.0.50 base files and removes candidate v0.0.63 added paths.
