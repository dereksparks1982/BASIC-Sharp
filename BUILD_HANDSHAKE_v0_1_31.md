# BASIC# Build Handshake v0.1.31

- Project: BASIC# Ruby Bootstrap Compiler
- Required base: v0.1.30
- Required commit: `30e1506`
- Required tag: `v0.1.30`
- Target: v0.1.31
...
- Rollback: commit `30e1506`, tag `v0.1.30`.
- Continuation: install, owner-validate, commit, and tag v0.1.31. Then choose the smallest creator-facing Profile 2 capability required for useful programs and eventual self-hosting.
