# BASIC# Build Handshake v0.0.28

- **Project:** BASIC# Ruby Bootstrap Compiler
- **Required base:** accepted v0.0.27
- **Required commit:** `f82b121`
- **Required tag:** `v0.0.27`
- **Target:** v0.0.28
- **Build:** BSharp Bytecode Loader and Complete Structural Validation 1
- **Package:** `BASIC_Sharp_Ruby_Bootstrap_Compiler_v0_0_28_BSHARP_BYTECODE_LOADER_AND_COMPLETE_STRUCTURAL_VALIDATION_1_CHANGED_FILES_ONLY.zip`
...
- **Rollback:** commit `f82b121`, tag `v0.0.27`
- **Continuation:** owner install and validation, then commit/tag; next eligible build is First BSharp Virtual Machine 1
- **Required input:** this changed-files-only ZIP applied to the exact accepted v0.0.27 tree
